...
I couldn’t find a study app that matched my workflow so I built one from scratch. Every feature reflects challenges I faced while studying and I hope it helps others too!  

Key frustrations I solved:

- Buttons not functioning correctly on click.  
...
- Task lists (add / remove / edit / reorder)  
- Focus mode timer with pause/resume and skip break/session options  
- Daily study logging  
- Export progress to CSV  
- Minimal HTML, CSS, JavaScript setup  
...
👉 [https://mailamudasser1-ops.github.io/Study-Tracker/](https://mailamudasser1-ops.github.io/Study-Tracker/)
